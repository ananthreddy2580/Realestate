...
function Project(){
    return (
        ...
        <div className="project1">
            ...
            <div className="p1">
                <img className='projectImage11' src={project1}></img>
                <p id='proj'>
        ...
        <div className="project2">
            ...
            <div className="p1">
            <img className='projectImage11' src={project2}></img>
            <p id='proj'>Investing in Urban Oasis Residences means more than owning property—it’s investing in an elevated way of life. With cutting-edge smart home features, such as automated lighting, climate control, and security systems, each residence brings modern technology to your fingertips. Designed with sustainability in mind, the property incorporates energy-efficient solutions like green roofing, solar integration, and water-saving appliances, supporting a responsible and future-focused lifestyle.
